...
describe("updateSelectedServices.deselect", () => {
    ...
    test("should do nothing when no services selected", () => {
    ...
    test("should return current state if action doesn't match", () => {
        const result = updateSelectedServices(["WeddingSession", "Photography"], {
            type: "" as any,
            service: "WeddingSession"
        });
    ...
    test("should return initial state if state is not defined", () => {
        const result = updateSelectedServices(undefined, {
            type: "Select",
            service: "WeddingSession"
        });
        expect(result).toEqual(["WeddingSession"]);
